...
#     is_has_feat = models.BooleanField(blank=True, default=False, verbose_name="是否有人脸特征",
#                                       help_text='是否有人脸特征')
...
#     age = models.IntegerField(null=True, blank=True, verbose_name="人脸的年龄，用于训练",
#                               help_text='人脸的年龄，用于训练')
#     gender = models.SmallIntegerField(choices=SEX_OPTION, default=2, verbose_name="性别",
