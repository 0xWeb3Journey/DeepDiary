<template>
  <div class="GraphExplorer-container">
    <!-- <h2>interactiveGraph</h2> -->
    <div style="height: 100%">
      <div id="GraphExplorer"></div>
    </div>
    <!--all UI controls-->
    <div>
      <!--toolbar-->
...
<script>
  ...
  export default {
    ...
    mounted() {
      ...
      var appExplorer = new igraph.GraphExplorer(
        document.getElementById('GraphExplorer')
      )
      appExplorer.loadGson(
